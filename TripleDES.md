...
```
    ...
    Enter password: anant
    Enter your message.
     Message length should not be more than 16 characters: shivi
    choose any one mode: ECB, CBC, OFB
     Enter 1 for ECB, 2 for CBC and 3 for OFB:  1
    Encrypted message is :  YõzyFÇdà
    Do you want to decrypt it too??
     Enter 1 if yes, 2 if no1
    Decrypted message is :  shivi
